...
function studentHelperRedirectHtml() {
  return [
    ...
    "      if (!params.has(\"legacy\")) params.set(\"legacy\", \"1\");",
    "      var query = params.toString();",
    "      var target = \"./student_helper.html\" + (query ? \"?\" + query : \"?legacy=1\") + hash;",
    "      window.location.replace(target);",
    "    })();",
    "  </script>",
    "</head>",
    "<body>",
    "  <p>Redirecting to <a href=\"./student_helper.html?legacy=1\">Student Helper</a>...</p>",
    "</body>",
    "</html>",
    "",
  ].join("\n");
...
function writeStudentHelperLegacyRedirect() {
  const indexHtml = studentHelperRedirectHtml();
  writePublicFile(path.join("crate", "student_helper", "index.html"), indexHtml);
  copyFileIfExists(path.join("crate", "student_helper", "student_helper.html"));
}
